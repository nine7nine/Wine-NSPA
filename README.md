...
| [io_uring Integration Plan](https://nine7nine.github.io/Wine-NSPA/io_uring-integration-plan.gen.html) | Phase-by-phase implementation plan and status. |
...
| [Shmem PI Futex Redesign](https://nine7nine.github.io/Wine-NSPA/shmem-pi-futex-redesign.gen.html) | FUTEX_LOCK_PI for shared-memory IPC (attempted, rejected). |
