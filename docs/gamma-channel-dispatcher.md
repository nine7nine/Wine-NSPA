...
15. [Flow Diagram](#15-flow-diagram)
...
Steps 2 and the unboost-and-rebooot inside the kernel REPLY handler
...
<svg width="100%" viewBox="0 0 980 640" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="210" y="625" class="gd-grn">REPLY = wake + drain + auto-rebooost</text>
